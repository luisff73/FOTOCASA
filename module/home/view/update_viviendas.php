 ...
 <br>
        ...
        <table border='0'>
            ...
            <tr>
                ...
                <td><input type="text" id="ref_catastral" name="ref_catastral" placeholder="ref_catastral" value="<?php echo $viviendas['ref_catastral'];?>" readonly/></td>
                <td><font color="red">
            ...
            <tr>
                <td>Categoria: </td>
                <?php
                    $categoria=explode(":", $viviendas['categoria']);
                ?>
                <td><select multiple size="6" id="categoria[]" name="categoria[]">
                    <?php
                        $busca_array=in_array("Piscina", $categoria);
                        if($busca_array){
                    ?>
                        <option value="Piscina" selected>Piscina</option>
                    <?php
                    ...
                    <?php
                        ...
                        if($busca_array){
                    ?>
                        <option value="Balcon" selected>Balcon</option>
                    <?php
                        }else{
                    ?>
                    ...
                    ?>
                    <?php
                        $busca_array=in_array("Gimnasio", $categoria);
                        if($busca_array){
                    ?>
                        <option value="Gimnasio" selected>Gimnasio</option>
                    <?php
                        }else{
                    ?>
                    ...
                    ?>
                    <?php
                        $busca_array=in_array("Sotano", $categoria);
                        if($busca_array){
                    ?>
                        <option value="Sotano" selected>Sotano</option>
                    <?php
                        }else{
                    ?>
                    ...
                    ?>
                    <?php
                        $busca_array=in_array("Jardinero", $categoria);
                        if($busca_array){
                    ?>
                        <option value="Jardinero" selected>Jardinero</option>
                    <?php
                        }else{
                    ?>
            ...
            <tr>
                ...
                <td>
                    <?php
                        if($viviendas['visible']==="1"){
                    ?>
                    <input type="radio" id="visible" name="visible" value="1" checked/>Si
                    <input type="radio" id="visible" name="visible" value="0"/>No
                    <?php
                        }else{
                    ?>
                    <input type="radio" id="visible" name="visible" value="1"/>Si
                    <input type="radio" id="visible" name="visible" value="0" checked/>No
                    <?php
                        }
                    ?>
                </td>
                <td><font color="red">
                    <span id="error_visible" class="error"></span>
                </font></td>
            <tr>
